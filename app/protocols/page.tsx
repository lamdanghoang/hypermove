  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <header className="text-center mb-8">
        ...
        <p className="text-slate-400">Explore native Bitcoin and wrapped Bitcoin yield opportunities</p>
      </header>
    ...
    <div className="bg-slate-800/50 rounded-lg shadow-lg p-6">
      <div className="flex justify-between items-start mb-4">
        ...
        <div className="text-right">
          <div className="text-2xl font-bold text-green-400">{protocol.current_apy}%</div>
      ...
      <div className="flex justify-between items-center text-sm">
        <div className="text-slate-400">
          TVL: <span className="font-semibold text-white">{protocol.tvl}</span>
        </div>
        <span
          className={`font-semibold px-2 py-1 rounded-full text-xs ${protocol.risk_level.toLowerCase().includes('low')
